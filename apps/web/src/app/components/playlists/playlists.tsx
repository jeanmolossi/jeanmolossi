    ...
    return (
        <Card key={playlist.id}>
            <CardHeader>
                ...
                <Link href={href} className={styles.playlist_cover}>
                    <AspectRatioCover
                        src={{
                            src: playlist.cover,
                            width: 1280,
            ...
            <CardContent>
                <small className="text-gray-400">
                    {playlist.publishedAt.toRelativeTime()}
                </small>
    ...
    return (
        <div className="animate-pulse w-full">
            <div className="mt-6 grid grid-cols-1 gap-6">
                ...
                <div aria-hidden={false} className={styles.divider}></div>

                <div aria-hidden={false} className={styles.pagination}>
