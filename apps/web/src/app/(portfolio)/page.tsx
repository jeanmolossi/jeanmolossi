...
import IAimg from '@/presentation/assets/images/cinematic_profile_pic_512x512.jpg';
...
export default function HomePage() {
    ...
    const items = [
        ...
        },
        {
            ...
            content: (
                <>
                    Trabalhando como garçom desenvolvi diversas habilidades que
                    melhoraram minha <b>comunicação</b> de forma clara e
                    objetiva.
                </>
            ),
        ...
        },
        {
            ...
            content: (
                <>
                    Desenvolvi sistemas web completos, desde <b>Frontend</b> até
                    os serviços de <b>Backend</b>. Utilizei majoritariamente
                    NodeJS no Backend e ReactJS no Frontend
                </>
            ),
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <b>Desenvolvedor Sênior</b> utilizando diversas techs,
                    dentre elas, as principais são Golang, Javascript/Typescript
                    e PHP.
                </>
            ),
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 place-items-center min-h-[calc(100vh-15rem)] p-6">
                <div className="flex flex-col gap-4">
                    <h1 className="text-2xl md:text-4xl md:leading-tight font-semibold">
                        {experienceInYears} Anos de Experiência: Elevando a
                        Qualidade do Desenvolvimento de Software sem Dores de
                        Cabeça
                    </h1>

                    <p className="leading-normal">
                        Com mais de uma década de excelência em desenvolvimento
                        de software e um compromisso inabalável com a segurança,
                        estou aqui para transformar suas ideias em soluções
                        digitais impecáveis. Conte com minha vasta experiência
                        para construir um futuro digital incrível juntos
                    </p>
                </div>
